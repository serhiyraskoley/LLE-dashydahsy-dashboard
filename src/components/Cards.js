...
const CustomCards = () => {
  const [projectCards, setProjectCards] = useState(cardData.map(card => ({ ...card, showFullDescirption: false })));
        ...
        <Row gutter={16} style={{ marginLeft: '300px' }}>
          {projectCards.map((card, index) => (
            ...
            <Col span={8} style={{ padding: 8}}>
              <div className='block'>
                {/* <Badge.Ribbon text={card.department} className='badge-ribbon-style'> */}
